...
class PayPeriodCommand extends Command {
	...
	public function fire()
	{
		...
		$infile = fopen("/var/www/bosapp/app/commands/week_check.txt", "r") or die("Unable to open file!");
		$check = fgetc($infile);
		if($check == '1') {
			...
			$outfile = fopen("/var/www/bosapp/app/commands/week_check.txt", "w") or die("Unable to open file!");
			fwrite($outfile, '0');
